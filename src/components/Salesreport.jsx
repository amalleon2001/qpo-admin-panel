    ...
    <div style={styles.page}>
      ...
      `}</style>
       <div style={styles.topBar}>
        <h2 className="poppins-title" style={styles.pageTitle}>Sales Reports</h2>  
      ...
      <div style={styles.tableWrapper}>
        <table style={styles.table}>
          <thead>
            <tr>
              {["Action", "Date", "Invoice ID", "Ride ID", "Rider Name", "Pickup", "Drop", "Distance (km)"].map((h) => (
          ...
          <tbody>
            {filtered.map((row, i) => (
              <tr key={i} style={{ background: "#fff" }}>
                <td style={styles.td}>
                  <button style={styles.eyeBtn}><EyeIcon /></button>
                </td>
