  ...
  return (
    <div className="p-4 pt-2 bg-white">
      ...
      <div className="bg-white p-2.5 rounded-md flex items-center gap-2.5 mb-3">
        ...
        <button onClick={() => toast.info('Add new hotspot')} className="bg-[#f4f4f4] text-gray-800 border border-gray-300 rounded-md py-1.75 px-4 text-base cursor-pointer">
          + Add Hotspot
        </button>
              ...
              <tr key={item.id} className="border-b border-[#e4e4e4] bg-white">
                ...
                <td className="p-2.5">
                  <span className="flex gap-3.5">
                    <FaEye className="cursor-pointer" onClick={() => toast.info(`View ${item.name}`)} />
