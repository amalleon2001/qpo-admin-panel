...
const styles = {
  ...
  filterBar: { display: "flex", alignItems: "center", gap: 32, marginBottom: 16 },
  ...
  select: {
    ...
    backgroundRepeat: "no-repeat", backgroundPosition: "right 10px center", outline: "none", minWidth: 130,
  },
  tableWrapper: { border: "1.5px solid #e0e0e0", borderRadius: 4, overflow: "auto" },
  table: { width: "100%", borderCollapse: "collapse", minWidth: 900 },
  th: { background: "#f0f0f0", color: "#333", fontWeight: 600, fontSize: 14, padding: "12px 18px", textAlign: "center", borderBottom: "1.5px solid #e0e0e0", whiteSpace: "nowrap" },
  td: { fontSize: 14, color: "#333", padding: "13px 18px", textAlign: "center", borderBottom: "1px solid #f0f0f0", whiteSpace: "nowrap" },
  eyeBtn: { background: "none", border: "none", cursor: "pointer", padding: 0, display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto" },
};
...
const sampleData = Array(6).fill({
  signupDate: "16 Jul 2025", time: "08:35", rideId: "R0001", riderName: "Manisha",
  mobileNumber: "0123456789", gender: "Female", installSource: "Deeplink", campaign: "Whatsapp",
});
  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.topBar}>
        <h2 className="poppins-title" style={styles.pageTitle}>Rider database</h2>
          ...
          <tbody>
            {sampleData.map((row, i) => (
              <tr key={i} style={{ background: "#fff" }}>
                <td style={styles.td}><button style={styles.eyeBtn}><EyeIcon /></button></td>
