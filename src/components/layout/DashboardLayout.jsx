...
import Dashboard from '../driver/dashboard/Dashboard';
import Sidebar from './Sidebar';
import Topbar from './Topbar';

import PlaceholderPage from './PlaceholderPage';
import LiveRideRequest from '../driver/liveActivities/LiveRideRequest';
import NewTrip from '../driver/liveActivities/NewTrip';
import RefillingTrip from '../driver/liveActivities/RefillingTrip';
import IdleDrivers from '../driver/liveActivities/IdleDrivers';
import OngoingDrivers from '../driver/liveActivities/OngoingDrivers';
import LiveDemand from '../driver/demandAndHotspot/LiveDemand';
import RideDirection from '../driver/demandAndHotspot/LiveDemandTable';
import HotspotTable from '../driver/demandAndHotspot/HotspotTable';
import PreviousReports from '../driver/demandAndHotspot/PreviousReports';
import ReportDetails from '../driver/demandAndHotspot/ReportDetails';
import GeofenceTable from '../driver/geofence/GeofenceTable';

import FullScreenStyles from './FullScreenStyles';
import PricingAlgorithm from '../driver/algorithm/PricingAlgorithm';
import DriverAlgorithm from '../driver/algorithm/DriverAlgorithm';
