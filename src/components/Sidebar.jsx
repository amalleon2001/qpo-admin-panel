...
function Sidebar({ active, setActive, openMenus, setOpenMenus }) {
      ...
      {items.map((item) => (
        <li key={item.key}>
          <div className="flex items-center">
            <a href="#" className="no-underline py-2 px-3 rounded flex-1 flex items-center gap-2 text-base"
              style={{
  ...
  return (
    <div className="flex flex-col shrink-0 pl-3 border-r border-gray-200 h-screen" style={{ width: 260, background: '#f7f9fb' }}>
