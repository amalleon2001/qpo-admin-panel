    ...
    <div style={styles.page}>
      ...
      <div style={styles.breadcrumb}>
        <div style={styles.breadcrumbLeft}>
          ...
          <span className="poppins-breadcrumb" style={styles.breadcrumbParent}>App Activity Logs</span>
          <span className="poppins-breadcrumb" style={styles.breadcrumbSeparator}>&gt;</span>
          <span className="poppins-breadcrumb" style={styles.breadcrumbCurrent}>Live App Activity</span>
        </div>
